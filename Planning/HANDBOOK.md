...
9. [Legacy Deployment Reference](#legacy-deployment-reference)
...
The `/src` directory contains **ONLY** code that runs on the public website. No internal tools, experiments, or unrelated projects should exist here.

**For details and guidelines, see**: [WEBSITE_SOURCE_POLICY.md](WEBSITE_SOURCE_POLICY.md)

**Examples of what belongs in `/src`:**
- ✅ Website pages and components
- ✅ Website API routes (auth, courses, payments)
- ✅ Website utilities and libraries

**Examples of what does NOT belong in `/src`:**
- ❌ Internal tools (BMAD, admin systems)
